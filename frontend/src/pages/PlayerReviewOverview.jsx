        ...
        <div className="techinical-skills">
          ...
          */}
          ...
          <div className="review-buttons">
            ...
            {playerOverview?.data.reactionTime ? (
              <Tag text="Picking" reviews={playerOverview?.data.reactionTime} />
            ) : (
              ''
            )}
            ...
            {playerOverview?.data.steadiness ? (
              <Tag text="Skirmishing" reviews={playerOverview?.data.steadiness} />
            ) : (
              ''
            )}
